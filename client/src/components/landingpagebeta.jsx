...
class LandingPageBeta extends React.Component {
  ...
  componentWillMount() {
    $('body').css('background-image', 'url(http://blog.creativelive.com/wp-content/uploads/2016/01/lights-night-unsharp-blured.jpg?utm_source=creativeLIVE&utm_medium=blog&utm_campaign=photo-video_bokeh-effect-tutorial&utm_content=text_link)');
  }
  loadLoginPage() {
  ...
  render() {
    return (
      <div>
        ...
        <div style={styles.info}>"The easiest Talent/Venue booking software"</div>
        ...
        <div id="below" style={styles.below}>
          ...
          <article style={styles.article}>
            ...
            <div style={styles.articlegif}>
              <iframe src="https://giphy.com/embed/AFIFa25PDLoRfQMUA9" width="480" height="294" frameBorder="0" className="giphy-embed" style={styles.gifright}></iframe>
            </div>
          </article>
          ...
          <article style={styles.article}>
            <div style={styles.articlegif}>
              <iframe src="https://giphy.com/embed/AFIFa25PDLoRfQMUA9" width="480" height="294" frameBorder="0" className="giphy-embed" style={styles.gifleft}></iframe>
            </div>
            <div style={styles.articlecontent}>
